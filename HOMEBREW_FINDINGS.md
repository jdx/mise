...
Fresh jdx-authored work reinforces this:

- [PR #11197](https://github.com/jdx/mise/pull/11197): structured flight
  steps and correct zap/uninstall receipt distinctions.
...
|---|---|---|
| [#10413](https://github.com/jdx/mise/discussions/10413) | Declarative package pruning | Led to formula import/prune; casks excluded |
...
- contradicts jdx's “cannot be recovered by mise” guidance for lost metadata.
...
6. If desired, design a separate explicit adoption experiment with a written
   lifecycle contract and tests before implementation.
