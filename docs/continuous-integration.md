...
CI installs the requested version instead of reusing the one that was installed first. This is the
non-localized wrapper: a localized one keeps its binary in its localized data directory
