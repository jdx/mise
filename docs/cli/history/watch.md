...
- **Usage:** `mise history watch [--once] [-J --json]`
- **Effect:** modifies state
- **Source code:** [`src/cli/history/watch.rs`](https://github.com/jdx/mise/blob/main/src/cli/history/watch.rs)
...
```
mise history watch
mise history watch --once      # one reconcile, for a timer
mise history watch --json
```
