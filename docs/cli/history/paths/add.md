...
# `mise history paths add`

- **Usage:** `mise history paths add [FLAGS] <PATH>…`
- **Effect:** modifies state
- **Source code:** [`src/cli/history/paths/add.rs`](https://github.com/jdx/mise/blob/main/src/cli/history/paths/add.rs)
