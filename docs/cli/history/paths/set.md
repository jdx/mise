...
# `mise history paths set`

- **Usage:** `mise history paths set [FLAGS] <PATH>…`
- **Effect:** modifies state
- **Source code:** [`src/cli/history/paths/set.rs`](https://github.com/jdx/mise/blob/main/src/cli/history/paths/set.rs)
