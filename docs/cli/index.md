...
Examples:
  ...
  $ mise plugins install node https://github.com/mise-plugins/mise-nodejs.git

  # install the node plugin using the git url only
  # (node is inferred from the url)
  $ mise plugins install https://github.com/mise-plugins/mise-nodejs.git

  # install the node plugin using a specific ref
  $ mise plugins install node https://github.com/mise-plugins/mise-nodejs.git#v1.0.0
```
...
Options:
  -u, --urls
          Show the git url for each plugin e.g.: https://github.com/mise-plugins/mise-nodejs.git
