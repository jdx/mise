...
- 2026-03-02 - [Top 10 Features in Mise You're Not Using](https://jdx.dev/posts/2026-03-02-10-mise-features/)
...
- 2025-01-12 - [French: Mise-En-Place: Simplifiez la Gestion de vos Environnements et Tâches](https://blog.stephane-robert.info/docs/outils/systeme/mise/)
...
- [hk](https://hk.jdx.dev/): run Git hooks and project lint checks.
- [pitchfork](https://pitchfork.jdx.dev/): supervise long-running development processes.
- [usage](https://usage.jdx.dev/): define CLI arguments, help, and completions; mise uses it
  for [task arguments](/tasks/task-arguments.html).

To suggest a resource or correct a link, see [Contributing](/contributing.html).
