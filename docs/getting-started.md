...
::: warning Shims do not support all the features of `mise activate`.<br> See
...
- Also note that this uses `~/.local/bin/mise` as the binary location since that's what <https://mise.run> uses by
