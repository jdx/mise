...
rtx use node-build to install nodejs runtimes, you need to ensure [dependencies](https://github.com/nodenv/node-build/wiki#suggested-build-environment) installed before installing python.
