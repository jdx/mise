...
The backend system is mise's core abstraction for tool management. Backend implementations provide hooks, while shared lifecycle operations are module functions:
