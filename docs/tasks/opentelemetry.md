...
task finishes. A group span opens with its first task and stays open until the run ends,
since mise can't know whether another task from that package is still to come.
