...
_mise() {
  ...
  if ( [[ -z "${_usage_spec_mise_2025_5_9:-}" ]] || _cache_invalid _usage_spec_mise_2025_5_9 ) \
      && ! _retrieve_cache _usage_spec_mise_2025_5_9;
  then
    spec="$(mise usage)"
    _store_cache _usage_spec_mise_2025_5_9 spec
  fi
