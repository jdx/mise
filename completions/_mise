...
_mise() {
  ...
  if ( [[ -z "${_usage_spec_mise_2024_11_23:-}" ]] || _cache_invalid _usage_spec_mise_2024_11_23 ) \
      && ! _retrieve_cache _usage_spec_mise_2024_11_23;
  then
    spec="$(mise usage)"
    _store_cache _usage_spec_mise_2024_11_23 spec
  fi
