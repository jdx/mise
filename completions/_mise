...
_mise() {
  ...
  if ( [[ -z "${_usage_spec_mise_2024_12_0:-}" ]] || _cache_invalid _usage_spec_mise_2024_12_0 ) \
      && ! _retrieve_cache _usage_spec_mise_2024_12_0;
  then
    spec="$(mise usage)"
    _store_cache _usage_spec_mise_2024_12_0 spec
  fi
