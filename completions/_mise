...
_mise() {
  ...
  if ( [[ -z "${_usage_spec_mise_2025_7_20:-}" ]] || _cache_invalid _usage_spec_mise_2025_7_20 ) \
      && ! _retrieve_cache _usage_spec_mise_2025_7_20;
  then
    spec="$(mise usage)"
    _store_cache _usage_spec_mise_2025_7_20 spec
  fi
