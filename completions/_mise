...
_mise() {
  ...
  if ( [[ -z "${_usage_spec_mise_2025_7_29:-}" ]] || _cache_invalid _usage_spec_mise_2025_7_29 ) \
      && ! _retrieve_cache _usage_spec_mise_2025_7_29;
  then
    spec="$(mise usage)"
    _store_cache _usage_spec_mise_2025_7_29 spec
  fi
