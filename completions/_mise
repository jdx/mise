...
_mise() {
  ...
  if ( [[ -z "${_usage_spec_mise_2025_6_5:-}" ]] || _cache_invalid _usage_spec_mise_2025_6_5 ) \
      && ! _retrieve_cache _usage_spec_mise_2025_6_5;
  then
    spec="$(mise usage)"
    _store_cache _usage_spec_mise_2025_6_5 spec
  fi
