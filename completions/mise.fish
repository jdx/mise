...
complete -xc mise -n "not $fssf $others" -a ls -d 'List installed and active tool versions'
...
complete -xc mise -n "not $fssf $others" -a shell -d 'Sets a tool version for the current session'
