...
impl ToolRequestSet {
    ...
    pub fn into_iter(self) -> impl Iterator<Item = (Arc<BackendArg>, Vec<ToolRequest>, ToolSource)> {
...
impl ToolRequestSetBuilder {
    ...
    async fn load_config_files(&self, config: &Config, mut trs: ToolRequestSet) -> eyre::Result<ToolRequestSet> {
