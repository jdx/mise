...
pub const SHORTHAND_LIST: [(&str, &str); 607] = [
    // rtx custom aliases
    ...
    (
        "actionlint",
        "https://github.com/crazy-matt/asdf-actionlint.git",
    ),
    ...
    (
        "aks-engine",
        "https://github.com/robsonpeixoto/asdf-aks-engine.git",
    ),
    ...
    (
        "aws-nuke",
        "https://github.com/bersalazar/asdf-aws-nuke.git",
    ),
    ("aws-sam-cli", "https://github.com/amrox/asdf-pyapp.git"),
    (
        "aws-sso-cli",
        "https://github.com/adamcrews/asdf-aws-sso-cli.git",
    ),
    (
        "aws-vault",
    ...
    (
        "awsweeper",
        "https://github.com/chessmango/asdf-awsweeper.git",
    ),
    ("azure-cli", "https://github.com/itspngu/asdf-azure-cli.git"),
    (
        "azure-functions-core-tools",
        "https://github.com/daveneeley/asdf-azure-functions-core-tools.git",
    ),
    ("babashka", "https://github.com/fredZen/asdf-babashka"),
    (
        "balena-cli",
        "https://github.com/boatkit-io/asdf-balena-cli",
    ),
    (
        "bashbot",
        "https://github.com/mathew-fleisch/asdf-bashbot.git",
    ),
    ...
    (
        "bbr",
        "https://github.com/vmware-tanzu/tanzu-plug-in-for-asdf.git",
    ),
    (
    ...
    (
        "bombardier",
        "https://github.com/NeoHsu/asdf-bombardier.git",
    ),
    ...
    (
        "buildpack",
        "https://github.com/johnlayton/asdf-buildpack.git",
    ),
    ("bun", "https://github.com/cometkim/asdf-bun.git"),
    (
        "bundler",
        "https://github.com/jonathanmorley/asdf-bundler.git",
    ),
    ("caddy", "https://github.com/salasrod/asdf-caddy.git"),
    (
        "camunda-modeler",
        "https://github.com/barmac/asdf-camunda-modeler.git",
    ),
    (
        "cargo-make",
        "https://github.com/kachick/asdf-cargo-make.git",
    ),
    ("carthage", "https://github.com/younke/asdf-carthage.git"),
    (
        "ccache",
        "https://github.com/asdf-community/asdf-ccache.git",
    ),
    (
        "certstrap",
        "https://github.com/carnei-ro/asdf-certstrap.git",
    ),
    ...
    (
        "chezscheme",
        "https://github.com/asdf-community/asdf-chezscheme.git",
    ),
    ("chicken", "https://github.com/evhan/asdf-chicken.git"),
    ("choose", "https://github.com/carbonteq/asdf-choose.git"),
    (
        "chromedriver",
        "https://github.com/schinckel/asdf-chromedriver.git",
    ),
    (
        "cidr-merger",
        "https://github.com/ORCID/asdf-cidr-merger.git",
    ),
    (
        "cilium-cli",
        "https://github.com/carnei-ro/asdf-cilium-cli.git",
    ),
    (
        "cilium-hubble",
        "https://github.com/NitriKx/asdf-cilium-hubble.git",
    ),
    (
        "clojure",
        "https://github.com/asdf-community/asdf-clojure.git",
    ),
    ("cloudflared", "https://github.com/threkk/asdf-cloudflared"),
    (
        "cloudsql-proxy",
        "https://github.com/itspngu/asdf-cloudsql-proxy.git",
    ),
    (
        "clusterawsadm",
        "https://github.com/kahun/asdf-clusterawsadm.git",
    ),
    (
        "clusterctl",
        "https://github.com/pfnet-research/asdf-clusterctl.git",
    ),
    (
        "cmake",
        "https://github.com/srivathsanmurali/asdf-cmake.git",
    ),
    ("cmctl", "https://github.com/asdf-community/asdf-cmctl.git"),
    (
        "cockroach",
        "https://github.com/salasrod/asdf-cockroach.git",
    ),
    (
        "codefresh",
        "https://github.com/gurukulkarni/asdf-codefresh.git",
    ),
    (
        "codeql",
        "https://github.com/bored-engineer/asdf-codeql.git",
    ),
    (
        "colima",
        "https://github.com/CrouchingMuppet/asdf-colima.git",
    ),
    ...
    (
        "container-diff",
        "https://github.com/cgroschupp/asdf-container-diff.git",
    ),
    (
        "container-structure-test",
        "https://github.com/jonathanmorley/asdf-container-structure-test.git",
    ),
    (
        "cookiecutter",
        "https://github.com/shawon-crosen/asdf-cookiecutter.git",
    ),
    ...
    (
        "coursier",
        "https://github.com/jiahuili430/asdf-coursier.git",
    ),
    ...
    (
        "crossplane-cli",
        "https://github.com/joke/asdf-crossplane-cli.git",
    ),
    (
        "crystal",
        "https://github.com/asdf-community/asdf-crystal.git",
    ),
    ...
    (
        "dagger",
        "https://github.com/virtualstaticvoid/asdf-dagger.git",
    ),
    ...
    (
        "difftastic",
        "https://github.com/volf52/asdf-difftastic.git",
    ),
    ("digdag", "https://github.com/jtakakura/asdf-digdag.git"),
    (
        "direnv",
        "https://github.com/asdf-community/asdf-direnv.git",
    ),
    ("dive", "https://github.com/looztra/asdf-dive.git"),
    (
        "djinni",
        "https://github.com/cross-language-cpp/asdf-djinni.git",
    ),
    ...
    (
        "docker-slim",
        "https://github.com/everpeace/asdf-docker-slim.git",
    ),
    (
        "dockle",
        "https://github.com/mathew-fleisch/asdf-dockle.git",
    ),
    ("doctl", "https://github.com/maristgeek/asdf-doctl.git"),
    (
        "doctoolchain",
        "https://github.com/joschi/asdf-doctoolchain",
    ),
    ("docuum", "https://github.com/bradym/asdf-docuum.git"),
    ("dome", "https://github.com/jtakakura/asdf-dome.git"),
    (
        "dotenv-linter",
        "https://github.com/wesleimp/asdf-dotenv-linter.git",
    ),
    ...
    (
        "driftctl",
        "https://github.com/nlamirault/asdf-driftctl.git",
    ),
    (
        "drone",
        "https://github.com/virtualstaticvoid/asdf-drone.git",
    ),
    ...
    (
        ...
        "https://github.com/gabitchov/asdf-editorconfig-checker.git",
    ),
    ...
    (
        "figma-export",
        "https://github.com/younke/asdf-figma-export.git",
    ),
    ("fillin", "https://github.com/ouest/asdf-fillin"),
    ("firebase", "https://github.com/jthegedus/asdf-firebase.git"),
    (
        "fission",
        "https://github.com/virtualstaticvoid/asdf-fission.git",
    ),
    ...
    (
        "fluxctl",
        "https://github.com/stefansedich/asdf-fluxctl.git",
    ),
    (
        "fly",
        "https://github.com/vmware-tanzu/tanzu-plug-in-for-asdf.git",
    ...
    (
        "gcc-arm-none-eabi",
        "https://github.com/dlech/asdf-gcc-arm-none-eabi.git",
    ),
    ("gcloud", "https://github.com/jthegedus/asdf-gcloud.git"),
    (
        "getenvoy",
        "https://github.com/asdf-community/asdf-getenvoy.git",
    ),
    ...
    (
        "git-chglog",
        "https://github.com/GoodwayGroup/asdf-git-chglog.git",
    ),
    ...
    (
        "github-markdown-toc",
        "https://github.com/skyzyx/asdf-github-markdown-toc.git",
    ),
    ("gitleaks", "https://github.com/jmcvetta/asdf-gitleaks.git"),
    (
        "gitsign",
        "https://github.com/spencergilbert/asdf-gitsign.git",
    ),
    ...
    (
        ...
        "https://github.com/dex4er/asdf-go-containerregistry.git",
    ),
    ...
    (
        "go-junit-report",
        "https://github.com/jwillker/asdf-go-junit-report.git",
    ),
    ("go-sdk", "https://github.com/yacchi/asdf-go-sdk.git"),
    (
        "go-swagger",
        "https://github.com/jfreeland/asdf-go-swagger.git",
    ),
    ...
    (
        "golangci-lint",
        "https://github.com/hypnoglow/asdf-golangci-lint.git",
    ),
    ("gomigrate", "https://github.com/joschi/asdf-gomigrate.git"),
    (
        "gomplate",
        "https://github.com/sneakybeaky/asdf-gomplate.git",
    ),
    ("gopass", "https://github.com/trallnag/asdf-gopass.git"),
    (
        "goreleaser",
        "https://github.com/kforsthoevel/asdf-goreleaser.git",
    ),
    ("goss", "https://github.com/raimon49/asdf-goss.git"),
    (
        "graalvm",
        "https://github.com/asdf-community/asdf-graalvm.git",
    ),
    ("gradle", "https://github.com/rfrancis/asdf-gradle.git"),
    (
        "gradle-profiler",
        "https://github.com/joschi/asdf-gradle-profiler.git",
    ),
    ...
    (
        "grpc-health-probe",
        "https://github.com/zufardhiyaulhaq/asdf-grpc-health-probe.git",
    ),
    (
        "grpcurl",
    ...
    (
        "gwvault",
        "https://github.com/GoodwayGroup/asdf-gwvault.git",
    ),
    (
        "hadolint",
        "https://github.com/devlincashman/asdf-hadolint.git",
    ),
    ("hamler", "https://github.com/scudelletti/asdf-hamler.git"),
    ("has", "https://github.com/sylvainmetayer/asdf-has"),
    (
        "haskell",
        "https://github.com/asdf-community/asdf-haskell.git",
    ),
    (
        "hasura-cli",
        "https://github.com/gurukulkarni/asdf-hasura.git",
    ),
    ...
    (
        ...
        "https://github.com/carlduevel/asdf-iam-policy-json-to-terraform.git",
    ),
    ("iamlive", "https://github.com/chessmango/asdf-iamlive.git"),
    ("idris", "https://github.com/asdf-community/asdf-idris.git"),
    (
        "idris2",
        "https://github.com/asdf-community/asdf-idris2.git",
    ),
    (
        "imagemagick",
        "https://github.com/mangalakader/asdf-imagemagick.git",
    ),
    ...
    (
        "kotlin",
        "https://github.com/asdf-community/asdf-kotlin.git",
    ),
    (
        "kpack-cli",
        "https://github.com/vmware-tanzu/tanzu-plug-in-for-asdf.git",
    ...
    (
        "kube-capacity",
        "https://github.com/looztra/asdf-kube-capacity.git",
    ),
    (
        "kube-code-generator",
        "https://github.com/jimmidyson/asdf-kube-code-generator.git",
    ),
    (
        "kube-controller-tools",
        "https://github.com/jimmidyson/asdf-kube-controller-tools.git",
    ),
    (
        "kube-credential-cache",
        "https://github.com/ryodocx/kube-credential-cache.git",
    ),
    (
        "kube-linter",
        "https://github.com/devlincashman/asdf-kube-linter.git",
    ),
    (
        "kube-score",
        "https://github.com/bageljp/asdf-kube-score.git",
    ),
    (
        "kubebuilder",
        "https://github.com/virtualstaticvoid/asdf-kubebuilder.git",
    ),
    ("kubecm", "https://github.com/samhvw8/asdf-kubecm"),
    (
        "kubeconform",
        "https://github.com/lirlia/asdf-kubeconform.git",
    ),
    (
        "kubectl",
    ...
    (
        "kubectl-bindrole",
        "https://github.com/looztra/asdf-kubectl-bindrole.git",
    ),
    (
        "kubectl-buildkit",
        "https://github.com/ezcater/asdf-kubectl-buildkit.git",
    ),
    (
        "kubectl-kots",
        "https://github.com/ganta/asdf-kubectl-kots.git",
    ),
    ("kubectx", "https://gitlab.com/wt0f/asdf-kubectx.git"),
    (
        "kubefedctl",
        "https://github.com/kvokka/asdf-kubefedctl.git",
    ),
    (
        "kubelogin",
        "https://github.com/sechmann/asdf-kubelogin.git",
    ),
    (
        "kubemqctl",
        "https://github.com/johnlayton/asdf-kubemqctl.git",
    ),
    (
        "kubent",
        "https://github.com/virtualstaticvoid/asdf-kubent.git",
    ),
    (
        "kubergrunt",
        "https://github.com/NeoHsu/asdf-kubergrunt.git",
    ),
    (
        "kubeseal",
        "https://github.com/stefansedich/asdf-kubeseal.git",
    ),
    ("kubesec", "https://github.com/vitalis/asdf-kubesec.git"),
    ("kubespy", "https://github.com/jfreeland/asdf-kubespy.git"),
    (
        "kubeval",
        "https://github.com/stefansedich/asdf-kubeval.git",
    ),
    ...
    (
        "lazygit",
        "https://github.com/nklmilojevic/asdf-lazygit.git",
    ),
    ...
    (
        "logtalk",
        "https://github.com/LogtalkDotOrg/asdf-logtalk.git",
    ),
    (
        "loki-logcli",
        "https://github.com/comdotlinux/asdf-loki-logcli.git",
    ),
    ("lua", "https://github.com/Stratus3D/asdf-lua.git"),
    (
        "luaJIT",
        "https://github.com/smashedtoatoms/asdf-luaJIT.git",
    ),
    ...
    (
        "mdbook-linkcheck",
        "https://github.com/cipherstash/asdf-mdbook-linkcheck.git",
    ),
    ...
    (
        "micronaut",
        "https://github.com/weibemoura/asdf-micronaut.git",
    ),
    ...
    (
        "mongo-tools",
        "https://github.com/itspngu/asdf-mongo-tools.git",
    ),
    ...
    (
        "newrelic-cli",
        "https://github.com/NeoHsu/asdf-newrelic-cli.git",
    ),
    ...
    (
        "openfaas-faas-cli",
        "https://github.com/zekker6/asdf-faas-cli.git",
    ),
    (
        "openresty",
        "https://github.com/smashedtoatoms/asdf-openresty.git",
    ),
    (
        "opensearch",
        "https://github.com/randikabanura/asdf-opensearch.git",
    ),
    (
        "openshift-install",
        "https://github.com/hhemied/asdf-openshift-install.git",
    ),
    (
        "operator-sdk",
        "https://github.com/Medium/asdf-operator-sdk.git",
    ),
    (
        "opsgenie-lamp",
        "https://github.com/ORCID/asdf-opsgenie-lamp",
    ),
    ...
    (
        "please",
        "https://github.com/asdf-community/asdf-please.git",
    ),
    ...
    (
        "polaris",
        "https://github.com/particledecay/asdf-polaris.git",
    ),
    ("popeye", "https://github.com/nlamirault/asdf-popeye.git"),
    (
        "postgres",
        "https://github.com/smashedtoatoms/asdf-postgres.git",
    ),
    (
        "powershell-core",
        "https://github.com/daveneeley/asdf-powershell-core.git",
    ),
    (
        "pre-commit",
        "https://github.com/jonathanmorley/asdf-pre-commit.git",
    ),
    ("protoc", "https://github.com/paxosglobal/asdf-protoc.git"),
    (
        "protoc-gen-go",
        "https://github.com/pbr0ck3r/asdf-protoc-gen-go.git",
    ),
    (
        "protoc-gen-go-grpc",
        "https://github.com/pbr0ck3r/asdf-protoc-gen-go-grpc.git",
    ),
    (
        "protoc-gen-grpc-web",
        "https://github.com/pbr0ck3r/asdf-protoc-gen-grpc-web.git",
    ),
    (
        "protoc-gen-js",
        "https://github.com/pbr0ck3r/asdf-protoc-gen-js.git",
    ),
    (
        "protolint",
        "https://github.com/spencergilbert/asdf-protolint.git",
    ),
    ("pulumi", "https://github.com/canha/asdf-pulumi.git"),
    ("purerl", "https://github.com/GoNZooo/asdf-purerl.git"),
    (
        "purescript",
        "https://github.com/nsaunders/asdf-purescript.git",
    ),
    ...
    (
        "redskyctl",
        "https://github.com/sudermanjr/asdf-redskyctl.git",
    ),
    ...
    (
        "rlwrap",
        "https://github.com/asdf-community/asdf-rlwrap.git",
    ),
    ...
    (
        "rust-analyzer",
        "https://github.com/Xyven1/asdf-rust-analyzer",
    ),
    (
        "saml2aws",
    ...
    (
        "scaleway-cli",
        "https://github.com/albarralnunez/asdf-plugin-scaleway-cli",
    ),
    ("sccache", "https://github.com/emersonmx/asdf-sccache.git"),
    ("scenery", "https://github.com/skyzyx/asdf-scenery.git"),
    (
        "schemacrawler",
        "https://github.com/davidecavestro/asdf-schemacrawler.git",
    ),
    (
        "semgrep",
        "https://github.com/brentjanderson/asdf-semgrep.git",
    ),
    ("semtag", "https://github.com/junminahn/asdf-semtag"),
    (
        "semver",
        "https://github.com/mathew-fleisch/asdf-semver.git",
    ),
    (
        "sentinel",
        "https://github.com/asdf-community/asdf-hashicorp.git",
    ...
    (
        "soft-serve",
        "https://github.com/chessmango/asdf-soft-serve.git",
    ),
    (
        "solidity",
        "https://github.com/diegodorado/asdf-solidity.git",
    ),
    ("sops", "https://github.com/feniix/asdf-sops.git"),
    (
        "sopstool",
        "https://github.com/elementalvoid/asdf-sopstool.git",
    ),
    ...
    (
        "swiftformat",
        "https://github.com/younke/asdf-swiftformat.git",
    ),
    ("swiftgen", "https://github.com/younke/asdf-swiftgen.git"),
    (
        "swiftlint",
        "https://github.com/klundberg/asdf-swiftlint.git",
    ),
    ...
    (
        "tekton-cli",
        "https://github.com/johnhamelink/asdf-tekton-cli.git",
    ),
    (
        "teleport-community",
    ...
    (
        "telepresence",
        "https://github.com/pirackr/asdf-telepresence.git",
    ),
    ("temporalite", "https://github.com/eko/asdf-temporalite.git"),
    (
        "terradozer",
        "https://github.com/chessmango/asdf-terradozer.git",
    ),
    (
        "terraform",
        "https://github.com/asdf-community/asdf-hashicorp.git",
    ...
    (
        "terraform-docs",
        "https://github.com/looztra/asdf-terraform-docs.git",
    ),
    (
        "terraform-ls",
        "https://github.com/asdf-community/asdf-hashicorp.git",
    ...
    (
        "terraform-lsp",
        "https://github.com/bartlomiejdanek/terraform-lsp.git",
    ),
    (
        "terraform-validator",
        "https://github.com/looztra/asdf-terraform-validator.git",
    ),
    ("terragrunt", "https://github.com/ohmer/asdf-terragrunt.git"),
    (
        "terramate",
        "https://github.com/martinlindner/asdf-terramate.git",
    ),
    (
        "terrascan",
        "https://github.com/hpdobrica/asdf-terrascan.git",
    ),
    (
        "tf-summarize",
        "https://github.com/adamcrews/asdf-tf-summarize.git",
    ),
    (
        "tfc-agent",
        "https://github.com/asdf-community/asdf-hashicorp.git",
    ...
    (
        "tfstate-lookup",
        "https://github.com/carnei-ro/asdf-tfstate-lookup.git",
    ),
    ...
    (
        "tonnage",
        "https://github.com/elementalvoid/asdf-tonnage.git",
    ),
    (
        "tool-versions-to-env",
        "https://github.com/smartcontractkit/tool-versions-to-env-action.git",
    ),
    ("trdsql", "https://github.com/johnlayton/asdf-trdsql.git"),
    (
        "tridentctl",
        "https://github.com/asdf-community/asdf-tridentctl.git",
    ),
    ("trivy", "https://github.com/zufardhiyaulhaq/asdf-trivy.git"),
    (
        "tsuru",
        "https://github.com/virtualstaticvoid/asdf-tsuru.git",
    ),
    (
        "uaa-cli",
        "https://github.com/vmware-tanzu/tanzu-plug-in-for-asdf.git",
    ...
    (
        "vultr-cli",
        "https://github.com/ikuradon/asdf-vultr-cli.git",
    ),
    (
        "wasi-sdk",
        "https://github.com/coolreader18/asdf-wasi-sdk.git",
    ),
    ...
    (
        "yamllint",
        "https://github.com/ericcornelissen/asdf-yamllint.git",
    ),
    ...
    (
        "zbctl",
        "https://github.com/camunda-community-hub/asdf-zbctl.git",
    ),
