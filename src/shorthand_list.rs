...
pub const SHORTHAND_LIST: [(&str, &str); 592] = [
    // rtx custom aliases
    ...
    (
        "aws-amplify-cli",
        "https://github.com/LozanoMatheus/asdf-aws-amplify-cli.git",
    ),
    ...
    (
        "bosh",
        "https://github.com/laidbackware/asdf-github-release-downloader.git",
    ),
