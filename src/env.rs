...
// ruby
pub static RTX_RUBY_BUILD_REPO: Lazy<String> = Lazy::new(|| "https://github.com/rbenv/ruby-build.git");
pub static RTX_RUBY_INSTALL_REPO: Lazy<String> = Lazy::new(|| "https://github.com/postmodern/ruby-install.git");
