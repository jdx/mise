...
pub(super) const EFFECTS: &[(&str, SpecCommandEffect)] = &[
    ...
    ("dotfiles diff", Read),
    ("dotfiles edit", Write),
    ("dotfiles exclude", Write),
    ("dotfiles history", Read),
    ("dotfiles history describe", Write),
    ("dotfiles history diff", Read),
    ...
    ("dotfiles paths", Read),
    ("dotfiles pull", Destructive),
    ("dotfiles recover", Destructive),
    ("dotfiles rollback", Destructive),
    ("dotfiles save", Write),
    ("dotfiles status", Read),
    ("dotfiles sync", Write),
    ("dotfiles track", Write),
