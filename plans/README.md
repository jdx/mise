...
|     3 | [Prove a supported Homebrew handoff](012-evaluate-homebrew-handoff.md)                  | P1       | L       | HIGH | **IN PROGRESS** — disposable GHA probe added; full matrix evidence pending              | 010                                         |
...
|    10 | [Narrow an upstream supported contract](009-upstream-homebrew-registration-contract.md) | P2       | M-L     | HIGH | BLOCKED — Plan 012 evidence/decision pending                                            | 012                                         |
...
|    13 | [Consolidate the decision record](005-consolidate-homebrew-decision-record.md)          | P2       | M       | LOW  | **DONE baseline** — revise after Plan 012 final evidence                                | 010; 012 final outcome                      |
