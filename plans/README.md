...
| ----: | --------------------------------------------------------------------------------------- | -------- | ------- | ---- | ---------------------------------------------- | ------------------------------------------- |
|     1 | [Retire unsafe synthetic metadata](010-retire-unsafe-cask-metadata.md)                  | P1       | M       | MED  | TODO                                           | none                                        |
|     2 | [Enforce cask path boundaries](011-secure-cask-path-boundaries.md)                      | P1       | M       | HIGH | TODO                                           | none                                        |
|     3 | [Prove a supported Homebrew handoff](012-evaluate-homebrew-handoff.md)                  | P1       | L       | HIGH | TODO                                           | 010                                         |
|     4 | [Record completed cask actions](013-record-completed-cask-actions.md)                   | P1       | L       | HIGH | TODO                                           | 011                                         |
|     5 | [Model ownership and prevent takeover](001-model-cask-ownership.md)                     | P1       | L       | HIGH | BLOCKED — revise after 012/013                 | 011, 012, 013                               |
|     6 | [Model constraints and dependency ownership](006-cask-dependencies.md)                  | P1       | L       | HIGH | BLOCKED — handoff eligibility                  | 001, 013                                    |
|     7 | [Add safe diagnosis and recovery](008-cask-interop-recovery.md)                         | P1       | L       | HIGH | BLOCKED — ownership model                      | 001, 012, 013                               |
|     8 | [Reconcile and test real lifecycle](003-reconcile-and-test-cask-interop.md)             | P1       | L       | HIGH | BLOCKED — selected direction                   | 008                                         |
|     9 | [Expand lifecycle parity by artifact class](004-expand-cask-lifecycle-parity.md)        | P2       | L/class | HIGH | BLOCKED — lifecycle gate                       | 003                                         |
|    10 | [Narrow an upstream supported contract](009-upstream-homebrew-registration-contract.md) | P2       | M-L     | HIGH | BLOCKED — gaps from 012                        | 012                                         |
|    11 | [Emit exact binary private metadata](002-emit-exact-binary-metadata.md)                 | P3       | L       | HIGH | BLOCKED — explicit private experiment decision | 001, 006, 013                               |
...
|    13 | [Consolidate the decision record](005-consolidate-homebrew-decision-record.md)          | P2       | M       | LOW  | TODO — immediate correction, then final pass   | 010; final after 012/009 outcome            |
