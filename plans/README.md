...
|     2 | [Enforce cask path boundaries](011-secure-cask-path-boundaries.md)                      | P1       | M       | HIGH | **DONE** — SafePathComponent + checked joins + app containment; adversarial tests | none                                        |
|     3 | [Prove a supported Homebrew handoff](012-evaluate-homebrew-handoff.md)                  | P1       | L       | HIGH | **STOP** — isolation unproven on operator host; mise-only retained | 010                                         |
|     4 | [Record completed cask actions](013-record-completed-cask-actions.md)                   | P1       | L       | HIGH | **DONE** — mutator facts + durable journal + post-activation receipt; legacy unverified | 011                                         |
|     5 | [Model ownership and prevent takeover](001-model-cask-ownership.md)                     | P1       | L       | HIGH | BLOCKED — revise after proven 012 handoff      | 011, 012, 013                               |
...
|    10 | [Narrow an upstream supported contract](009-upstream-homebrew-registration-contract.md) | P2       | M-L     | HIGH | BLOCKED — 012 STOP; no production transfer     | 012                                         |
...
|    13 | [Consolidate the decision record](005-consolidate-homebrew-decision-record.md)          | P2       | M       | LOW  | **DONE** — ADR + support matrix; contradictions archived | 010; 012 STOP outcome                       |
