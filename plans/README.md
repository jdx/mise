...
|     2 | [Enforce cask path boundaries](011-secure-cask-path-boundaries.md)                      | P1       | M       | HIGH | **DONE** — SafePathComponent + checked joins + app/`$APPDIR` + request-token equality   | none                                        |
