...
pub fn executable_for_shell(value: &str) -> Cow<'_, str> {
...
pub fn windows_path_list_for_shell(value: &str) -> Cow<'_, str> {
    match ACTIVE_MAPPER.as_ref() {
...
pub fn windows_path_entries_for_shell(value: &str) -> Vec<String> {
    match ACTIVE_MAPPER.as_ref() {
...
pub fn orig_path_for_windows(value: &str) -> Cow<'_, str> {
    match ACTIVE_MAPPER.as_ref() {
