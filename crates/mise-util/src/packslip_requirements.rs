...
impl Report {
    pub fn enforce(&self, ignore: bool) -> Result<()> {
...
pub fn meets_minimum(actual: &str, min: &str) -> Option<bool> {
...
pub async fn check(artifact: &Artifact, commands: &BTreeMap<String, PathBuf>) -> Report {
