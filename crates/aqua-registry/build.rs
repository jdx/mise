...
fn create_empty_baked_registry() {
    ...
    let empty_registry_code = r#"// This file is automatically generated by build.rs. Do not edit manually.
...
fn bake_registry() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut code_lines = vec![
        "// This file is automatically generated by build.rs. Do not edit manually.".to_string(),
        "#[allow(clippy::all, warnings)]".to_string(),
        "{".to_string(),
