...
```
curl https://github.com/jdx/rtx/releases/download/v2023.11.8/rtx-v2023.11.8-linux-x64 > /usr/local/bin/rtx
...
>
> See [`RTX_FISH_AUTO_ACTIVATE=1`](#rtx-fish-auto-activate) for more information.
