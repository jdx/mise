      ...
      "subcommands": [
        {
          ...
          "args": [
            ...
            },
            {
              ...
              "isOptional": false,
              "isVariadic": false,
              "generators": completionGeneratorTemplate(`mise alias ls {{words[PREV]}} | awk '{print $2}'`)
            }
          ]
        },
        {
          ...
          "options": [
            ...
            },
            {
              ...
              "args": {
                ...
                "isOptional": false,
                "isVariadic": false,
                "generators": completionGeneratorTemplate(`mise tasks | awk '{print $1}'`)
              }
            },
            {
              "name": [
          ...
          "args": [
            {
              ...
              "isOptional": false,
              "isVariadic": false,
              "generators": completionGeneratorTemplate(`mise settings --keys`)
            },
            {
              "name": "value",
